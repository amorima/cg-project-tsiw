...
const platforms = [
    ...
    new Platform(19, 7.5, 3, 0.5, {type:'oneway', minGridY:3.5, maxGridY:7.5, vy:80}),
    ...
    new Platform(34, 9.5, 3, 0.5, {type:'oneway', minGridX:34, maxGridX:37, vx:80}),
];

// === RESIDUO SPAWN SYSTEM ===
const possibleResiduoPositions = [
    {x:2, y:10},
    {x:3, y:11},{x:3,y:5},{x:3,y:7},
    {x:4,y:9},
    {x:5,y:6},{x:5,y:11},
    {x:6,y:6},{x:6,y:11},
    {x:7,y:9},
    {x:8,y:5},{x:8,y:7},{x:8,y:11},
    {x:9,y:10},
    {x:10,y:9},{x:10,y:11},
    {x:12,y:4},{x:12,y:8},{x:12,y:11},
    {x:13,y:5},{x:13,y:9},
    {x:14,y:11},
    {x:15,y:7},{x:15,y:10},
    {x:16,y:6},
